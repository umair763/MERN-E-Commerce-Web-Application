  ...
  return (
    <div className="mt-6 flex flex-col gap-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm md:flex-row md:items-center md:justify-between">
      ...
      <p className="text-sm text-gray-600">
        Showing <span className="font-semibold text-gray-900">{fromIndex}</span> to{" "}
        <span className="font-semibold text-gray-900">{toIndex}</span> of{" "}
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-1">
          ...
          {getPages().map((page, index) =>
            page === "..." ? (
              <span key={index} className="px-2 text-sm font-medium text-gray-400">
                ...
              </span>
            ) : (
              <button
